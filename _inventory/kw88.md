...
+ CM Launcher
: [CM Launcher](https://play.google.com/store/apps/details?id=com.ksmobile.launcher&hl=ja&rdid=com.ksmobile.launcher)を入れてみる。  
重い。
...
: ランチャーが好みだったので。
  ...
  **インストール**  
   1. [Universal Launcher New Gen](https://play.google.com/store/apps/details?id=com.ricktop.ClockSkinCoco&hl=ja)をインストール
...
1. [©Round Android Smartwatches-Custom Faces-not Wear.](https://plus.google.com/communities/109827242607524552712)から好みのスキンを**PCに**ダウンロード、解凍
1. KW88をPCに繋ぐ
1. `clockskin`フォルダに解凍したファイル群をフォルダごと突っ込む
1. 文字盤を数秒タッチ
1. 右端までフリック
